...
export class Homepage extends Component {
  ...
  // Apply Filters
  applyFilters = (e) => {
    const { starFilter, propFilter, facilityFilter, priceFilter } = this.state;
    ...
    updatedList = updatedList.filter(
      (item) =>
        item.name.toLowerCase().search(this.state.searchValue.toLowerCase()) !==
        -1
    );
  ...
  render() {
    ...
    return (
      <Container searchItem={this.searchItem}>
        <Box display="flex">
